app.controller('FriendController', function($scope, $location, FriendService) {
	...
	$scope.acceptRequest = function(userID) {
		FriendService.acceptRequest(userID).then(function(response) {
	...
	$scope.rejectRequest = function(userID) {
		FriendService.rejectRequest(userID).then(function(response) {
	...
	$scope.removeFriend = function(friendID) {
		FriendService.removeFriend(friendID).then(function(response) {
	...
	$scope.sentRequest = FriendService.getSentRequest().then(
			function(response) {
	...
	$scope.cancelRequest = function(friendID) {
		FriendService.cancelRequest(friendID).then(function(response) {
